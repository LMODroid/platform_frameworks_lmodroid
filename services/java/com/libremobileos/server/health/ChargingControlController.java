...
import static com.libremobileos.server.health.Util.getTimeMillisFromSecondOfDay;
import static com.libremobileos.server.health.Util.msToString;
...
public class ChargingControlController extends LineageHealthFeature {
    ...
    public boolean isEnabled() {
        return Settings.System.getInt(mContentResolver,
                LMOSettings.System.CHARGING_CONTROL_ENABLED, 0) != 0;
    }

    public boolean setEnabled(boolean enabled) {
        putBoolean(LMOSettings.System.CHARGING_CONTROL_ENABLED, enabled);
        return true;
    }
    ...
    public boolean setMode(int mode) {
        ...
        putInt(LMOSettings.System.CHARGING_CONTROL_MODE, mode);
        return true;
    }
    ...
    public boolean setStartTime(int time) {
        ...
        putInt(LMOSettings.System.CHARGING_CONTROL_START_TIME, time);
        return true;
    }
    ...
    public boolean setTargetTime(int time) {
        ...
        putInt(LMOSettings.System.CHARGING_CONTROL_TARGET_TIME, time);
        return true;
    }
    ...
    public boolean setLimit(int limit) {
        ...
        putInt(LMOSettings.System.CHARGING_CONTROL_LIMIT, limit);
        return true;
    }
