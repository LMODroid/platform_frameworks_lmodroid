...
public class OutdoorModeController extends LiveDisplayFeature {
    ...
    public void onStart() {
        ...
        registerSettings(
                Settings.System.getUriFor(LMOSettings.System.DISPLAY_AUTO_OUTDOOR_MODE));
    }
    ...
    boolean setAutomaticOutdoorModeEnabled(boolean enabled) {
        ...
        putBoolean(LMOSettings.System.DISPLAY_AUTO_OUTDOOR_MODE, enabled);
        return true;
    }

    boolean isAutomaticOutdoorModeEnabled() {
        return mUseOutdoorMode && (mNightDisplayAvailable ||
                getBoolean(LMOSettings.System.DISPLAY_AUTO_OUTDOOR_MODE,
