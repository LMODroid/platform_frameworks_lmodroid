 ...
 *               2018-2024 The LineageOS Project
 *
...
public class DisplayHardwareController extends LiveDisplayFeature {
    ...
    private static final Uri DISPLAY_AUTO_CONTRAST =
            Settings.System.getUriFor(LMOSettings.System.DISPLAY_AUTO_CONTRAST);
    private static final Uri DISPLAY_COLOR_ADJUSTMENT =
            Settings.System.getUriFor(LMOSettings.System.DISPLAY_COLOR_ADJUSTMENT);
    private static final Uri DISPLAY_COLOR_ENHANCE =
            Settings.System.getUriFor(LMOSettings.System.DISPLAY_COLOR_ENHANCE);
    private static final Uri DISPLAY_CABC =
            Settings.System.getUriFor(LMOSettings.System.DISPLAY_CABC);
    private static final Uri DISPLAY_READING_MODE =
            Settings.System.getUriFor(LMOSettings.System.DISPLAY_READING_MODE);
    private static final Uri DISPLAY_ANTI_FLICKER =
            Settings.System.getUriFor(LMOSettings.System.DISPLAY_ANTI_FLICKER);
    ...
    boolean isAutoContrastEnabled() {
        return mUseAutoContrast &&
                getBoolean(LMOSettings.System.DISPLAY_AUTO_CONTRAST, mDefaultAutoContrast);
    }
    ...
    boolean setAutoContrastEnabled(boolean enabled) {
        ...
        putBoolean(LMOSettings.System.DISPLAY_AUTO_CONTRAST, enabled);
        return true;
    }

    boolean isCABCEnabled() {
        return mUseCABC &&
                getBoolean(LMOSettings.System.DISPLAY_CABC, mDefaultCABC);
    }
    ...
    boolean setCABCEnabled(boolean enabled) {
        ...
        putBoolean(LMOSettings.System.DISPLAY_CABC, enabled);
        return true;
    }

    boolean isColorEnhancementEnabled() {
        return mUseColorEnhancement &&
                getBoolean(LMOSettings.System.DISPLAY_COLOR_ENHANCE,
    ...
    boolean setColorEnhancementEnabled(boolean enabled) {
        ...
        putBoolean(LMOSettings.System.DISPLAY_COLOR_ENHANCE, enabled);
        return true;
    }
    ...
    float[] getColorAdjustment() {
        ...
        if (!parseColorAdjustment(getString(LMOSettings.System.DISPLAY_COLOR_ADJUSTMENT), cur)) {
    ...
    private void saveColorAdjustmentString(final float[] adj) {
        ...
        putString(LMOSettings.System.DISPLAY_COLOR_ADJUSTMENT, sb.toString());
    }
    ...
    boolean isAntiFlickerEnabled() {
        return mUseAntiFlicker &&
                getBoolean(LMOSettings.System.DISPLAY_ANTI_FLICKER, mDefaultAntiFlicker);
    }
    ...
    boolean setAntiFlickerEnabled(boolean enabled) {
        ...
        putBoolean(LMOSettings.System.DISPLAY_ANTI_FLICKER, enabled);
        return true;
    }
}
