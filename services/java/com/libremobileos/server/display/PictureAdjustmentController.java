...
public class PictureAdjustmentController extends LiveDisplayFeature {
    ...
    public void onStart() {
        ...
        registerSettings(
                Settings.System.getUriFor(LMOSettings.System.DISPLAY_PICTURE_ADJUSTMENT));
    }
    ...
    private SparseArray<HSIC> unpackPreference() {
        ...
        String pref = getString(LMOSettings.System.DISPLAY_PICTURE_ADJUSTMENT);
        if (pref != null) {
    ...
    private void packPreference(final SparseArray<HSIC> modes) {
        ...
        putString(LMOSettings.System.DISPLAY_PICTURE_ADJUSTMENT, sb.toString());
    }
