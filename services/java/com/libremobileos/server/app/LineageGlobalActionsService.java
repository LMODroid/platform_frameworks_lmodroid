...
import static com.libremobileos.util.PowerMenuConstants.GLOBAL_ACTION_KEY_BUGREPORT;
import static com.libremobileos.util.PowerMenuConstants.GLOBAL_ACTION_KEY_LOCKDOWN;
...
import com.libremobileos.app.ILineageGlobalActions;
import com.libremobileos.providers.LMOSettings;
import com.libremobileos.util.PowerMenuConstants;
...
public class LineageGlobalActionsService extends SystemService {
    ...
    private String[] getUserConfig() {
        String savedActions = Settings.Secure.getStringForUser(mContentResolver,
                LMOSettings.Secure.POWER_MENU_ACTIONS, UserHandle.USER_CURRENT);
    ...
    private void saveUserConfig() {
        ...
        Settings.Secure.putStringForUser(mContentResolver, LMOSettings.Secure.POWER_MENU_ACTIONS, s, UserHandle.USER_CURRENT);
    }
