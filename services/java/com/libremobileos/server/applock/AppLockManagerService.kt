...
import com.libremobileos.applock.AppLockData
import com.libremobileos.applock.AppLockManager
import com.libremobileos.applock.IAppLockManagerService
...
private const val ACTION_APP_LOCK_TIMEOUT = "com.libremobileos.server.applock.AppLockManagerService.APP_LOCK_TIMEOUT"
...
class AppLockManagerService(
     ...
     *     [com.libremobileos.Manifest.permission.MANAGE_APP_LOCK].
     ...
     */
    @RequiresPermission(com.libremobileos.Manifest.permission.MANAGE_APP_LOCK)
    ...
    private fun enforceCallingPermission(msg: String) {
        context.enforceCallingPermission(com.libremobileos.Manifest.permission.MANAGE_APP_LOCK, msg)
    }
    ...
    class Lifecycle(context: Context) : SystemService(context) {
        ...
        override fun onStart() {
            publishBinderService(LMOContextConstants.APP_LOCK_SERVICE, service)
            service.onStart()
        }
