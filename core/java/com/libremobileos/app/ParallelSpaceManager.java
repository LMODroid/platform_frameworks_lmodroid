 ...
 * It requires com.libremobileos.Manifest.permission.MANAGE_PARALLEL_SPACES.
 * 
 * @hide
 */
public final class ParallelSpaceManager {
    ...
    private ParallelSpaceManager() {
        mParallelSpaceManager = IParallelSpaceManager.Stub.asInterface(
                ServiceManager.getService(LMOContextConstants.PARALLEL_SERVICE));
