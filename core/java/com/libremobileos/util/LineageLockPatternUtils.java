...
package com.libremobileos.util;
...
public class LineageLockPatternUtils extends LockPatternUtils {
    ...
    public boolean shouldPassToSecurityView(int userId) {
        return getBoolean(LMOSettings.Secure.LOCK_PASS_TO_SECURITY_VIEW, false, userId);
    }
    public void setPassToSecurityView(boolean enabled, int userId) {
        setBoolean(LMOSettings.Secure.LOCK_PASS_TO_SECURITY_VIEW, enabled, userId);
    }
}
